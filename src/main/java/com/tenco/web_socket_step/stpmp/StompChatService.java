...
import com.tenco.web_socket_step.stpmp.StompChat;
import com.tenco.web_socket_step.stpmp.StompChatRepository;
...
public class StompChatService {
    ...
    public void saveAndBroadCast(Long roomId, String message, String sender) {
        ...
        // 예) roomId 5 라면 "/sub/chat/5" 를 구독중인 클아이언트 들에게 메시지가 초고속으로 전달 됩니다.
